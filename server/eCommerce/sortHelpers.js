const sortByNumInStock = (arrayOfProducts) => {
...
const sortPriceHighToLow = (arrayOfProducts) => {
...
const sortPriceLowToHigh = (arrayOfProducts) => {
  const sortedArrayOfProducts = arrayOfProducts.sort(
...
const sortByName = (arrayOfProducts) => {
  const sortedArrayOfProducts = arrayOfProducts.sort((a, b) =>
